...
const heads: HeadsInterface[] = [{ name: "ID", key: 'id' }, { name: "Title", key: 'title' }, { name: "Body", key: 'body' }]
...
export default function Home() {
    const { data: users, isLoading: usersLoading, isError: usersError, isSuccess: usersSuccess } = useQuery(['users',], () => fetchUsers())
    ...
    return (
        <Box sx={{ width: "100%", mt: 10 }}>
            <Container maxWidth="xl" sx={{ ml: 0, }}>
                ...
                <PostsTable length={length} page={page} user={user} url='posts' heads={heads} />

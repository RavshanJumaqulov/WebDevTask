...
import { Box, Container, Typography, FormControl, Button, Select, MenuItem, SelectChangeEvent, Pagination } from '@mui/material';
...
const postsLength = 50
const heads: HeadsInterface[] = [{ name: "ID", key: 'id' }, { name: "Title", key: 'title' }, { name: "Image", key: 'url' }, { name: "Image", key: 'thumbnailUrl' }]


export default function UserAlbumPhotos() {
        ...
        <Box sx={{ width: "100%", mt: 10 }}>
            <Container maxWidth="xl" sx={{ ml: 0, }}>
                <Typography variant='subtitle2' color='text.secondary' sx={{ textAlign: 'center' }}>
                    Bitta albomga tegishli photolar
                </Typography>
                ...
                <FilterPostsTable length={length} page={page} user={user} url='photos' heads={heads} id={albumId} filterText={'albumId'} />
